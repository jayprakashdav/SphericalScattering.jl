...
@testset "layeredDielectric" begin
    ...
    radii = SVector(0.25, 0.5, 1.0)
    fmat = SVector(Medium(ε1, μ1), Medium(ε1, μ1), Medium(ε1, μ1))
    sp = LayeredSphere(radii=radii, embedding=Medium(ε2, μ2), filling=fmat)
